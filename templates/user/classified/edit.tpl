...
{form enctype='multipart/form-data' cssClass='z-form'}
    ...
    <fieldset>
        ...
        <div class="z-formrow">
            ...
            {if $mode ne 'create'}
                {formdateinput group='classified' id='classifiedStart' mandatory=false __title='Enter the classified start of the classified' includeTime=true cssClass=' validate-daterange-classified' }
            {else}
                {formdateinput group='classified' id='classifiedStart' mandatory=false __title='Enter the classified start of the classified' includeTime=true defaultValue='now' cssClass=' validate-daterange-classified' }
            {/if}
