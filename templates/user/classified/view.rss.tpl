{* purpose of this template: classifieds rss feed in user area *}
...
{foreach item='classified' from=$items}
    <item>
        ...
        <link>{modurl modname='Classifieds' type='user' func='display' ot='classified' id=$classified.id fqurl='1'}</link>
        <guid>{modurl modname='Classifieds' type='user' func='display' ot='classified' id=$classified.id fqurl='1'}</guid>
