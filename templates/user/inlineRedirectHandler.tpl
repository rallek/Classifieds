...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <script type="text/javascript" src="{$baseurl}modules/Classifieds/javascript/Classifieds_editFunctions.js"></script>
    </head>
    <body>
        ...
        /* <![CDATA[ */
            ...
            document.observe('dom:loaded', function() {
                clfsCloseWindowFromInside('{{$idPrefix}}', {{if $commandName eq 'create'}}{{$itemId}}{{else}}0{{/if}});
            });
        /* ]]> */
        </script>
    </body>
