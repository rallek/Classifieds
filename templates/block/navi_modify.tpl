...
<div class="z-formrow">
    <label for="classifiedsTemplate">{gt text='Template'}:</label>
        <select id="classifiedsTemplate" name="template">
            <option value="navi_display.tpl"{if $template eq 'navi_display.tpl'} selected="selected"{/if}>{gt text='Only item titles'}</option>
            <option value="navi_display_description.tpl"{if $template eq 'navi_display_description.tpl'} selected="selected"{/if}>{gt text='With description'}</option>
...
<div id="customTemplateArea" class="z-formrow z-hide">
    <label for="classifiedsCustomTemplate">{gt text='Custom template'}:</label>
        ...
        <span class="z-sub z-formnote">{gt text='Example'}: <em>navi_{$objecttype}_display.tpl</em></span>
</div>
