...
<div style="margin-left: 80px">
    <div class="z-formrow">
        {formlabel for='classifiedsObjectType' __text='Object type'}
            {classifiedsObjectTypeSelector assign='allObjectTypes'}
            {formdropdownlist id='classifiedsObjectType' dataField='objectType' group='data' mandatory=true items=$allObjectTypes}
    ...
    <div{* class="z-formrow"*}>
        ...
        {classifiedsItemSelector id='id' group='data' objectType=$objectType}
    </div>
