{* purpose of this template: classifieds display view in admin area *}
...
<div class="classifieds-classified classifieds-display">
    ...
    {include file='admin/include_categories_display.tpl' obj=$classified}
    {include file='admin/include_standardfields_display.tpl' obj=$classified}
