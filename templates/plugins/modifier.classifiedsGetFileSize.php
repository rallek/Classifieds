...
/**
 * The classifiedsGetFileSize modifier displays the size of a given file in a readable way.
 *
 ...
 */
function smarty_modifier_classifiedsGetFileSize($size = 0, $filepath = '', $nodesc = false, $onlydesc = false)
{
    if (!is_numeric($size)) {
        $size = (int) $size;
    }
    ...
    $viewHelper = new Classifieds_Util_View($serviceManager);
