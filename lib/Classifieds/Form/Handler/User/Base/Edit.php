 ...
 */
class Classifieds_Form_Handler_User_Base_Edit extends Zikula_Form_AbstractHandler
{
    /**
    ...
    public function initialize(Zikula_Form_View $view)
    {
        ...
        $controllerHelper = new Classifieds_Util_Controller($this->view->getServiceManager());
    ...
    protected function getRedirectCodes()
    {
        ...
        $codes[] = 'ajax';
        // ajax display page of treated entity
        $codes[] = 'ajaxDisplay';
    ...
    protected function writeRelationDataToEntity_rec($entity, $entityData, $plugins)
    {
        foreach ($plugins as $plugin) {
            if ($plugin instanceof Classifieds_Form_Plugin_AbstractObjectSelector && method_exists($plugin, 'assignRelatedItemsToEntity')) {
    ...
    {
        foreach ($plugins as $plugin) {
            if ($plugin instanceof Classifieds_Form_Plugin_AbstractObjectSelector && method_exists($plugin, 'persistRelatedItems')) {
