 ...
 */
class Classifieds_Api_Base_User extends Zikula_AbstractApi
{
    /**
    ...
    public function getlinks()
    {
        ...
        if (in_array('classified', $allowedObjectTypes)
            && SecurityUtil::checkPermission($this->name . ':Classified:', '::', ACCESS_READ)) {
            $links[] = array('url' => ModUtil::url($this->name, 'user', 'view', array('ot' => 'classified')),
    ...
    public function encodeurl(array $args = array())
    {
        ...
        $routerFacade = new Classifieds_RouterFacade();
        ...
        $modInfo = ModUtil::getInfoFromName('Classifieds');
