 ...
 */
class Classifieds_Api_Base_Mailz extends Zikula_AbstractApi
{
    /**
    ...
    public function getPlugins(array $args = array())
    {
        ...
        $plugins[] = array(
            'pluginid'      => 1,
            'module'        => 'Classifieds',
            'title'         => $this->__('3 newest classifieds'),
            'description'   => $this->__('A list of the three newest classifieds.')
        );
        $plugins[] = array(
            'pluginid'      => 2,
            'module'        => 'Classifieds',
            'title'         => $this->__('3 random classifieds'),
            'description'   => $this->__('A list of three random classifieds.')
        );
        return $plugins;
    }
    ...
    public function getContent(array $args = array())
    {
        ...
        $idFields = ModUtil::apiFunc('Classifieds', 'selection', 'getIdFields', array('ot' => $objectType));
        ...
        list($entities, $objectCount) = ModUtil::apiFunc('Classifieds', 'selection', 'getEntitiesPaginated', $selectionArgs);
    
        $view = Zikula_View::getInstance('Classifieds', true);
        ...
        if ($args['contenttype'] == 't') { /* text */
            return $view->fetch('mailz/itemlist_classified_text.tpl');
        } else {
            //return $view->fetch('contenttype/itemlist_display.html');
            return $view->fetch('mailz/itemlist_classified_html.tpl');
        }
    }
}
