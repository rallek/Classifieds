 ...
 */
class Classifieds_Api_Base_Cache extends Zikula_AbstractApi
{
    /**
    ...
    public function clearItemCache(array $args = array())
    {
        ...
        $view = Zikula_View::getInstance('Classifieds');
        ...
        $cacheIds[] = 'Classifieds/user/main'; // main function
        $cacheIds[] = 'Classifieds/user/view/' . $objectType; // view function (list views)
        $cacheIds[] = 'Classifieds/user/display/' . $objectType . '|' . $instanceId; // display function (detail views)
