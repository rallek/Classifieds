 ...
 */
class Classifieds_ContentType_Base_Item extends Content_AbstractContentType
{
    ...
    public function getTitle()
    {
        ...
        return __('Classifieds detail view', $dom);
    }
    ...
    public function getDescription()
    {
        ...
        return __('Display or link a single Classifieds object.', $dom);
    }
    ...
    public function display()
    {
        if ($this->id != null && !empty($this->displayMode)) {
            return ModUtil::func('Classifieds', 'external', 'display', $this->getDisplayArguments());
        }
