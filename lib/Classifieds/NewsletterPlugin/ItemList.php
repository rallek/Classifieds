 ...
 */
class Classifieds_NewsletterPlugin_ItemList extends Newsletter_AbstractPlugin
{
    /**
    ...
    {
        return $this->__('Latest classifieds');
    }
    ...
    {
        return $this->__('List of classifieds');
    }
    ...
    {
        return $this->__('This plugin shows a list of classifieds of the Classifieds module.');
    }
    ...
    public function getParameters()
    {
        ...
        if (ModUtil::available($this->modname) && ModUtil::loadApi($this->modname)) {
            $objectTypes['classified'] = array('name' => $this->__('Classifieds'));
        }
