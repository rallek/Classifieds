 ...
 */
class Classifieds_Util_Base_ListEntries extends Zikula_AbstractBase
{
    /**
    ...
    public function getEntries($objectType, $fieldName)
    {
        ...
        switch ($objectType) {
            case 'classified':
                switch ($fieldName) {
                    case 'workflowState':
                        $entries = $this->getWorkflowStateEntriesForClassified();
                        break;
                    case 'kind':
                        $entries = $this->getKindEntriesForClassified();
                        break;
                }
                break;
        }
     ...
     * @return array Array with desired list entries.
     */
    public function getWorkflowStateEntriesForClassified()
    {
        $states = array();
     ...
     * @return array Array with desired list entries.
     */
    public function getKindEntriesForClassified()
    {
        $states = array();
        $states[] = array('value'   => 'offer',
                          'text'    => $this->__('Offer'),
                          'title'   => '',
                          'image'   => '',
                          'default' => true);
