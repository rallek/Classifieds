 ...
 */
class Classifieds_Listener_ModuleDispatch extends Classifieds_Listener_Base_ModuleDispatch
{
    /**
    ...
    public static function serviceLinks(Zikula_Event $event)
    {
        ...
        // Format data like so:
        // $event->data[] = array('url' => ModUtil::url('Classifieds', 'user', 'main'), 'text' => __('Link Text'));
    }
}
