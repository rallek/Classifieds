 ...
 */
class Classifieds_Block_Base_ItemList extends Zikula_Controller_AbstractBlock
{
    /**
    ...
    {
        SecurityUtil::registerPermissionSchema('Classifieds:ItemListBlock:', 'Block title::');
    ...
    public function info()
    {
        ...
        return array('module'          => 'Classifieds',
                     'text_type'       => $this->__('Classifieds list view'),
                     'text_type_long'  => $this->__('Display list of Classifieds objects.'),
                     'allow_multiple'  => true,
                     'form_content'    => false,
                     'form_refresh'    => false,
                     'show_preview'    => true,
    ...
    public function display($blockinfo)
    {
        ...
        if (!SecurityUtil::checkPermission('Classifieds:ItemListBlock:', "$blockinfo[title]::", ACCESS_OVERVIEW)) {
            return false;
        }
